...
![alt text](../../98-Notebook-Images/DHCP-Relay实验拓扑.png)
...
客户端与中继之间：
![alt text](../../98-Notebook-Images/DHCP抓包-1.png)
中继与服务器之间：
![alt text](../../98-Notebook-Images/DHCP抓包-2.png)
...
客户端与中继之间：
![alt text](../../98-Notebook-Images/DHCP抓包-3.png)
中继与服务器之间：
![alt text](../../98-Notebook-Images/DHCP抓包-4.png)

由于Vlanif30是固定分配的IP地址，所以服务器没有进行ping测

在Vlanif10上实验会发现，服务器收到Discover报文，从地址池中选择IP地址后，确实ping了这个地址，在未ping通后再返回Offer

![alt text](../../98-Notebook-Images/DHCP抓包-5.png)